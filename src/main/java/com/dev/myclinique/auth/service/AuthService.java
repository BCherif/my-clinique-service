...
import com.dev.myclinique.auth.wrapper.AuthBody;
...
public class AuthService {
    ...
    public CResponse<AuthBody> login(String username, String password) {
        try {
            ...
            if (!user.isActive()) {
                return CResponse.error("Vous n'etes plus autorise à vous connecter.\n"
            ...
            return CResponse.success(new AuthBody(user,jwtTokenProvider.createToken(user)), "Vous êtes authentifiés avec succès");
